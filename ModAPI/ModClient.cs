...
namespace eightyseven.ModApi
{
    ...
    public class ModClient
    {
        ...
        private static ModClient _instance = new ModClient();
        ...
        public static FsmBool getRatchetSwitch
        {
            get
            {
                ...
                {
                    _instance._ratchetSwitch = getFPS.transform.Find("2Spanner/Pivot/Ratchet").gameObject.GetPlayMaker("Switch").FsmVariables.GetFsmBool("Switch");
                }
        ...
        public static void print(string format, params object[] args)
        {
            ...
            {
                Debug.Log(string.Format("<color=grey>[ModAPI] " + format + "</color>", args));
            }
            else
            {
                if (log == null)
