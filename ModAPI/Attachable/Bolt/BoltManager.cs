    ...
    public class BoltManager
    {
        ...
        private void loadBoltAssets()
        {
            ...
            if (!_assetsLoaded)
            {
                ...
                nutPrefab = ab.LoadAsset<GameObject>("nut.prefab");
                shortBoltPrefab = ab.LoadAsset<GameObject>("short bolt.prefab");
                longBoltPrefab = ab.LoadAsset<GameObject>("long bolt.prefab");
                screwPrefab = ab.LoadAsset<GameObject>("screw.prefab");
                ab.Unload(false);
                _assetsLoaded = true;
            }
